...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setToast({ type: 'success', message: 'Welcome back to SubDash!' });
      setTimeout(() => {
        navigate('/dashboard');
      }, 1500);
    } catch (error) {
  ...
  return (
    <div className="flex min-h-[75vh] items-center justify-center py-6 sm:py-12">
      <div className="w-full max-w-md p-8 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-800 rounded-3xl shadow-xl transition-all">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 dark:text-white">Sign in to SubDash</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your SaaS subscription packages</p>
        </div>
