...
const Profile = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto py-6 space-y-8">
      {/* Page Header */}
      <div>
        <h1 className="text-3xl font-extrabold text-gray-855 dark:text-white tracking-tight">
          Account Settings
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Info Sidebar card */}
        <div className="bg-white dark:bg-gray-850 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-md text-center h-fit">
          ...
          <h2 className="text-lg font-bold text-gray-850 dark:text-white truncate">{user?.name}</h2>
          <p className="text-sm text-gray-450 dark:text-gray-500 truncate mb-4">{user?.email}</p>
          <span className="inline-flex px-3 py-1 rounded-full text-xs font-bold bg-primary-50 text-primary-750 dark:bg-primary-950/20 dark:text-primary-400">
            {user?.role?.toUpperCase()}
          </span>
        </div>

        {/* Edit Fields Form */}
        <div className="md:col-span-2 bg-white dark:bg-gray-850 p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-md">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 pt-6">
              <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2 mb-4">
                <KeyRound className="w-4 h-4 text-primary-550" />
